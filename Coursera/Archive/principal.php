...
<html lang="en">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Coursera Project</a>
    </div>
 ...
 <?php echo $row_user['FirstName']; ?> <?php echo $row_user['LastName']; ?><span class="caret"></span></a>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <h1 class="my-4">Write a Message</h1>
    ...
    <strong>User Table</strong>
     <a href="usertable.php" class="btn btn-default btn-lg btn-block">Download</a>
        ...
        <div class="col-lg-8">
          ...
          <div class="card mt-4">
            <div style="background-color: transparent; width: 800px; height: 75px;"></div>
...
$totalRows_senderis = mysql_num_rows($senderis); ?>
  ...
  <strong>Oh snap!</strong> <a href="#" class="alert-link">No messages for read
</div>
<?php } ?>
...
<?php }else{ ?>
  ...
  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>Oh snap!</strong> <a href="#" class="alert-link">No messages sent
<?php } ?>
